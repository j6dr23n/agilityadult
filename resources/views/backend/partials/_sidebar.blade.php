        ...
        <div class="main-sidebar-header active">
            <a class="header-logo active" href="{{ route('admin.index') }}">
                ...
                <img src="{{ asset('backend/assets/img/brand/favicon.png') }}"" class="         main-logo  mobile-logo"
                    alt="logo">
                <img src="{{ asset('backend/assets/img/brand/agadult.png') }}" class="main-logo  mobile-dark"
                    alt="logo">
            </a>
        </div>
        <div class="main-sidemenu">
            ...
            <ul class="side-menu">
                ...
                @if (auth()->user()->isAdmin())
                    ...
                    <li class="slide">
                        <a class="side-menu__item" data-bs-toggle="slide" href="{{ route('pages.working-day') }}"><svg
                            ...
                            </svg><span class="side-menu__label">Working Days</span></a>
                    </li>
                    <li class="side-item side-item-category">Girls</li>
                    <li class="slide">
                        <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);"><svg
                            ...
                            </svg><span class="side-menu__label">Girls</span><i
                                class="angle fe fe-chevron-right"></i></a>
                        <ul class="slide-menu">
                            <li class="side-menu__label1"><a href="javascript:void(0);">Girls</a></li>
                            <li><a class="slide-item" href="{{ route('girls.index') }}">View All</a></li>
                            <li><a class="slide-item" href="{{ route('girls.create') }}">Create Girl</a></li>
                        </ul>
                    </li>
                @endif
                ...
                @if (auth()->user()->isAdmin())
                    ...
                    <li class="slide">
                        <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);"><svg
                            ...
                            </svg><span class="side-menu__label">Users</span><i
                                class="angle fe fe-chevron-right"></i></a>
                        <ul class="slide-menu">
