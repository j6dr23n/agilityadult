    ...
    <aside class="app-sidebar">
        ...
        <div class="main-sidemenu">
            ...
            <ul class="side-menu">
                ...
                <li class="side-item side-item-category">Videos</li>
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);"><svg
                        ...
                        </svg> <span class="side-menu__label">Videos</span><i class="angle fe fe-chevron-right"></i></a>
                    <ul class="slide-menu">
                        <li class="side-menu__label1"><a href="javascript:void(0);">Videos</a></li>
                        <li><a class="slide-item" href="{{ route('videos.index') }}">View All</a></li>
                        <li><a class="slide-item" href="{{ route('videos.create') }}">Create Video</a></li>
                    </ul>
                </li>
