        ...
        <div class="main-container container-fluid">
            ...
            <div class="breadcrumb-header justify-content-between">
                <div class="left-content">
                    <span class="main-content-title mg-b-0 mg-b-lg-1">Sub Category of ({{ $category->title }})</span>
                </div>
                <div class="justify-content-center mt-2">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item tx-15"><a href="{{ route('categories.index') }}">{{ $category->title }}</a></li>
                ...
                <div class="col-12 col-sm-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Sub Category of ({{ $category->title }})</h4>
                        </div>
                        <div class="card-body pt-0">
                            <div class="table-responsive">
                                        ...
                                        @foreach ($sub_cat as $item)
                                            <tr>
                                                ...
                                                <td class="actions">
                                                    ...
                                                    <form action="{{ route('sub-categories.destroy', $item->id) }}" method="POST"
                                ...
                                <br>
                                {{ $sub_cat->onEachSide(0)->links('backend.partials._pagination') }}
                            </div>
                        </div>
                    </div>
                </div>
