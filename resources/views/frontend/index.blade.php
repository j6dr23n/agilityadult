                            ...
                            <section>
                                <div class="home-section mb-3 pb-1">
                                    <header
                                        ...
                                        <h6 class="font-size-24 font-weight-medium m-0 text-white">{{ $title === null ? 'All Video' : ucfirst($title) }}</h6>
                                    </header>
                                                    ...
                                                    <div class="col-md-3 px-2">
                                                        <div class="product mb-4">
                                                            ...
                                                            <div class="font-size-12 text-gray-1300">
                                                                ...
                                                                <span class="product-comment">Published on {{ \Carbon\Carbon::parse($item->created_at)->diffForHumans() }}</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                @endforeach
