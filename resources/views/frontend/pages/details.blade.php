...
<link rel="stylesheet" href="https://unpkg.com/swiper@8/swiper-bundle.min.css" / @endsection
    @section('content') <main id="content">
    ...
    @if ($video->drive_id !== null) <video id="my-video" class="video-js" controls preload="auto"
